# 12. Write a program that calculates the kinetic energy of a moving object,
# using the formula E = (mv²) / 2, where E is the kinetic energy, m is the mass of the object, and v is the velocity.
