# 11. Write a program that calculates the average velocity of an object,
# using the formula v = Δs/Δt, where v is the average velocity, Δs is the space variation, and Δt is the time variation
